...
Route::post('fetchonecomment/{id}', array('uses' => 'CommentController@fetchone'));
Route::post('deleteonecomment/{id}', array('uses' => 'CommentController@deleteone'));
Route::post('postcommentcount/{id}', array('uses' => 'CommentController@jsonCommentCount'));
